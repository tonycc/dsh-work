...
- 每位用户由系统自动维护一个唯一的默认个人 Workspace，未显式选择团队空间的新对话归入该空间；
- 所有 Session、文件和 Artifact 必须归属个人或团队 Workspace，不允许空归属；
- 个人 Workspace 仅本人访问且不能扩大企业数据权限；
...
| V1.6 | 2026-08-31 | 增加每位用户唯一默认个人工作空间，要求所有对话、文件和成果始终归属个人或团队工作空间 |
